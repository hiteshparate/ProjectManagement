            ...
            <tbody style="font-size: 14px;align-content: center">
                ...
                foreach ($data as $d) {
                    ...
                    <tr class="">
                        ...
                        <td class="p_a text-dark" align="center"><?php echo \App\area_of_interest::find($d["student"]->area_of_interest)->name ?></td>
                        ...
                        if ($d["report"]->report_location != null) {
                            ?>
                            <td class="text-dark font-13" align="center"><a target="_blank" href="/get_std_report/<?php echo $d["report"]->id ?>" class="btn btn-primary font-13 std_view_report">View Report</a></td>
                            <?php
                        }
                        ?>
...
<script src="{{ asset('js/rc_report.js') }}" type="text/javascript"></script>
