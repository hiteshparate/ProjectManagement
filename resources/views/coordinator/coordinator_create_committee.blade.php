            ...
            <tbody style="font-size: 14px;align-content: center">
                ...
                foreach ($students as $student) {
                    ...
                    <tr>
                        ...
                        <td id="<?php echo $student->id ?>" class="text-dark std_prg_id" align="center"><?php echo App\Student::find($student->student_id)->username ?></td>
                        <td class="text-dark" align="center"><?php echo $student->project_topic ?></td>
                        <td class="text-dark" align="center"><?php echo App\area_of_interest::find($student->area_of_interest)->name ?></td>
                        <td class="text-dark" align="center"><?php echo $student->project_type ?></td>
                        <td class="text-dark" align="center"><?php
                            if ($student->mentor_2 != null) {
                                echo "1) " . App\Faculty::find($student->mentor_1)->name . "<br>" . "2) " . App\Faculty::find($student->mentor_2)->name;
                            } else {
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/save_final_committee_btech" method="POST" class="form-horizontal">
                        {{ csrf_field() }}
    ...
    <div class="modal" id="edit_committee_members" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/edit_final_committee_btech" method="POST" class="form-horizontal">
                        {{ csrf_field() }}
...
<script src="{{ asset('js/coordinator_create_committee.js') }}" type="text/javascript"></script>
