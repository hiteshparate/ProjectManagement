...
<html>
    <head>
        ...
        <link href="{{ asset('css/icons.css') }}" rel="stylesheet" type="text/css"/>
        <!--<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/7.12.9/sweetalert2.css" />-->
        <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/6.6.4/sweetalert2.min.css" />
        <!--<link rel="stylesheet" href="https://www.jsdelivr.com/projects/sweetalert2" />-->
        @yield('css')
    ...
    <body class="widescreen fixed-left">
        ...
        <div id="wrapper" class="forced">
            ...
            <div class="topbar">
                ...
                <div class="navbar-default">
                    <div class="row"> 
                        ...
                        <div class="col-xs-10 text-center m-t-15">
                            <h2 class="text-dark"  style="font-size: 22px;margin-left: 275px">University Student Project Management and Evaluation System
                            ...
                            <ul class="nav navbar-default pull-right">
                                <li class="dropdown">
                                    <a href="" class="dropdown-toggle profile waves-effect waves-light font-bold" style="font-size: 16px" data-toggle="dropdown" aria-expanded="true">
                                        <?php echo Auth::guard(Illuminate\Support\Facades\Session::get('role'))->user()->username ?>
                                    </a>
            ...
            <div class="content-page" style="margin-left: 0px">
                ...
                @include('layouts.faculty_snippet.footer')
