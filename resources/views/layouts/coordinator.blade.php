...
<html>
    ...
    <body class="widescreen fixed-left">
        ...
        <div id="wrapper" class="forced">
            ...
            <!-- Top Bar Start -->
            @include('layouts.coordinator_snippet.topbar')
            <!-- Top Bar End -->


            <!-- ========== Left Sidebar Start ========== -->
            @include('layouts.coordinator_snippet.leftsidebar')
            ...
            <div class="content-page">
                ...
                @include('layouts.coordinator_snippet.footer')
